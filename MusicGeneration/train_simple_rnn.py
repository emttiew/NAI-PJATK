...
def train_network_simple_rnn():
    ...
    model = create_network_simple_rnn(network_input, n_vocab)

    train_simple_rnn(model, network_input, network_output)
...
def create_network_simple_rnn(network_input, n_vocab):
